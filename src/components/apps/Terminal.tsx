  ...
  const handleCommand = (cmd: string) => {
    ...
    switch (trimmedCmd) {
      ...
      case 'systeminfo':
        ...
        break;
      case 'whoami':
        output = <p className="text-cyan-400 font-mono">Aadhithya-PC\\Aadhithya (Software Developer & Full-Stack Developer)</p>;
        break;
      case 'dir':
      case 'ls':
      case 'get-childitem':
        output = (
          <div className="font-mono text-xs text-gray-300">
            <div className="text-white/50 mb-1">Directory of C:\Users\Aadhithya\Portfolio</div>
  ...
  return (
    ...
    >
      <div className="mb-4 text-[#0078d4] border-b border-white/10 pb-2">
        Windows PowerShell — aadhithya@AADHITHYA-PC<br />
      ...
      {history.map((item, index) => (
        <div key={index} className="mb-3">
          <div className="flex items-center gap-1 font-mono text-xs">
            ...
            <span className="text-[#0078d4]">C:\Users\Aadhithya&gt;</span>
