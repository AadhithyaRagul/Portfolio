...
const TASKBAR_ITEMS = [
  ...
  { id: 'askAadhithya', label: 'Ask Aadhithya', accent: '#8764ff', icon: Sparkles },
];
    ...
    <div className="fixed bottom-0 left-0 right-0 h-12 bg-[#1c1c1c]/90 border-t border-white/10 backdrop-blur-2xl flex items-center justify-between px-3 z-50 select-none text-gray-200 shadow-[0_-2px_15px_rgba(0,0,0,0.5)]">
      ...
      <div className="flex items-center gap-1">
        ...
        {TASKBAR_ITEMS.map((item) => {
          ...
          const isAskAadhithya = item.id === 'askAadhithya';
            ...
            <div key={item.id} className="relative flex flex-col items-center group">
              ...
              <button
                ...
                className={`relative h-10 rounded-md flex items-center justify-center transition-all duration-200 ${
                  isAskAadhithya ? 'px-3 gap-1.5 border border-purple-500/20 hover:border-purple-400/50 hover:bg-gradient-to-r hover:from-purple-600/30 hover:to-indigo-600/30 hover:shadow-[0_0_15px_rgba(168,85,247,0.45)]' : 'w-10'
                } ${
                  isFocused
                    ? isAskAadhithya ? 'bg-purple-600/30 border-purple-400/60 shadow-[0_0_12px_rgba(168,85,247,0.4)]' : 'bg-white/15 shadow-inner scale-105'
                    : isOpen
              ...
              <div
                className={`absolute bottom-0.5 rounded-full transition-all duration-200 ${
                  isFocused
                    ? isAskAadhithya ? 'w-6 h-[3px] bg-purple-400 shadow-[0_0_8px_#a855f7]' : 'w-4 h-[3px] bg-[#0078d4] shadow-[0_0_8px_#0078d4]'
                    : isOpen
          ...
          {showQuickSettings && (
            <div className="absolute right-0 bottom-14 w-80 bg-[#2c2c2c]/95 border border-white/10 rounded-xl p-4 shadow-2xl backdrop-blur-2xl z-50 text-gray-200 animate-in fade-in slide-in-from-bottom-2 duration-150">
              ...
              <div className="mt-4 pt-3 border-t border-white/10 flex justify-between items-center text-[10px] text-gray-400">
                <span>Aadhithya Windows 11 Pro</span>
