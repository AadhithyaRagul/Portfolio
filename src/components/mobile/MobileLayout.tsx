...
import AskAadhithya from '../apps/AskAadhithya';
...
const MOBILE_APPS: Record<string, { component: React.ComponentType; label: string; icon: React.ReactNode }> = {
  ...
  askAadhithya: { component: AskAadhithya, label: 'Ask Aadhithya', icon: <Sparkles size={22} /> },
};

const APP_ORDER = ['about', 'projects', 'experience', 'skills', 'achievements', 'photos', 'resume', 'contact', 'terminal'];
    ...
    <div className="fixed inset-0 bg-[#202020] text-white overflow-hidden flex flex-col">
      <div className="flex-1 overflow-y-auto">
        <div className="p-6 space-y-8">
          ...
          {/* Ask Aadhithya */}
          <button
            onClick={() => setActiveApp('askAadhithya')}
          ...
          >
            ...
            <span className="font-semibold text-lg">Ask Aadhithya</span>
          </button>
